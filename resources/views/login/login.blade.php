...
<head>
    ...
    <title>Login Brand 10K CLUB</title>
                    ...
                    <div class="card card-signup">
                        <form class="form" method="" action="">
                            ...
                            <div class="footer text-center">
                                <a onclick="login()" class="btn btn-simple btn-primary btn-lg">Login!</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    function login() {
        ...
        $.ajax({
            method: 'POST',
            url: 'http://ec2-35-163-3-65.us-west-2.compute.amazonaws.com/login_auth',
            data: data,
            dataType: 'json',
            success: function () {
