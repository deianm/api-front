...
<div class="wrapper">
    <div class="header header-filter">
        <img src="{!! ('img/girlrelaxing.jpg') !!}" style=" background-size: cover; background-position: top center; position:fixed;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="title">Welcome to 10K CLUB!</h1>
                    <h4>Advertise your products with Instagram users!</h4>
                    <br />
                </div>
            </div>
        </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="copyright pull-right">
                &copy; 2016, made with <i class="fa fa-heart heart"></i> by LMi
            </div>
        </div>
    </footer>
-->
